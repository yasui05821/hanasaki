<template>
  <section class="container">
    <div class="container">
      ...
      <div class="flower">
        <img :class="isActive" src="~/assets/images/color/c01.jpg" alt="">
        <img :class="isActive2" src="~/assets/images/color/c02.jpg" alt="">
        <img :class="isActive3" src="~/assets/images/color/c03.jpg" alt="">
        <img :class="isActive4" src="~/assets/images/color/c04.jpg" alt="">
      </div>
    </div>
  </section>
</template>
